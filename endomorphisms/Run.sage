# Generates endomorphism data for old format
...
#inputfile = 'LMFDB/database_input.txt'
#outputfile = 'LMFDB/database_output.txt'
# For debugging:
inputfile = 'LMFDB/database_input_test.txt'
outputfile = 'LMFDB/database_output_test.txt'
                ...
                if len(linesplit) == n:
                    ...
                    # Avoiding a nasty infinite loop:
                        ...
                        try:
                            ...
                            if EDs_sage[len(EDs_sage) - 1][4] == linesplit[2]:
                                outputstream.write(linestart
